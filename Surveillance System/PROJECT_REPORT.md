...
The model is trained and benchmarked using publicly accessible surveillance datasets:
1. **Roboflow Violence Image Dataset**: [`shah-xxxqs/violence-3h8pw`](https://universe.roboflow.com/shah-xxxqs/violence-3h8pw)
   - **Total Images**: 2,834 annotated surveillance images
   - **Splits**: 1,969 Train (70%), 575 Val (20%), 290 Test (10%)
2. **Kaggle Real-Life Violence Video Dataset**: [`mohamedmustafa/real-life-violence-situations-dataset`](https://www.kaggle.com/datasets/mohamedmustafa/real-life-violence-situations-dataset)
   - **Total Videos**: 2,000 video clips (1,000 Violence, 1,000 Non-Violence)
3. **Reference Research Repository**: [`aatansen/Violence-Detection-Using-YOLOv8-Towards-Automated-Video-Surveillance-and-Public-Safety`](https://github.com/aatansen/Violence-Detection-Using-YOLOv8-Towards-Automated-Video-Surveillance-and-Public-Safety)
...
To justify the selection of **YOLOv8s + ByteTrack**, candidate deep learning backbones and object detection models were benchmarked across 25 epochs:

| Architecture Backbone | Epochs | Wall-Clock Training Time | Accuracy | Precision | Recall | F1-Score | FPS | Selection Status |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
...
*Conclusion*: YOLOv8s + ByteTrack provided the optimal trade-off between high mAP (94.8%), manageable training duration (15.3 minutes), and high inference throughput (23.8 FPS) on standard hardware.
